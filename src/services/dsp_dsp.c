...
u32 dsp_dsp_SyncRequest()
{
    ...
    case 0x001100c2: { //LoadComponent
        ...
        u32 unk1 = mem_Read16(CPUsvcbuffer + 0x88);
        u32 unk2 = mem_Read16(CPUsvcbuffer + 0x8C);
        ...
        free(outbuff);
        mem_Write32(CPUsvcbuffer + 0x84, 0x0); //no error
    ...
    case 0x00150082: { //RegisterInterruptEvents
        ...
        myeventhandel = mem_Read32(CPUsvcbuffer + 0x90);
    ...
    case 0x001000c0: { //ReadPipeIfPossible
        ...
        u32 size = mem_Read16(CPUsvcbuffer + 0x8C);
        u32 buffer = mem_Read32(CPUsvcbuffer + 0x184);
        DEBUG("ReadPipeIfPossible %08X %08X %04X %08X\n", unk1, unk2, size, buffer);
        mem_Write32(CPUsvcbuffer + 0x84, 0); //no error
        return 0;
    }
    case 0x000c0040: { //ConvertProcessAddressFromDspDram
        u32 addrin = mem_Read32(CPUsvcbuffer + 0x84);
        DEBUG("ConvertProcessAddressFromDspDram %08X\n", addrin);
        mem_Write32(CPUsvcbuffer + 0x88, DSPramaddr + addrin);
        mem_Write32(CPUsvcbuffer + 0x84, 0); //no error
        return 0;
    }
    }
