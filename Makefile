...
LIBS    = `pkg-config sdl2 --libs` -lpthread -lm $(MINGW_LIBS)
LDFLAGS = $(MINGW_LDFLAGS)

SRC_FILES = src/mem.c src/screen.c src/handles.c src/loader.c src/utils.c src/svc.c src/config.c src/gdb/gdbstubchelper.c src/gdb/gdbstub.c src/gdb/gdb.c
